  ...
  <div class="">
    <table border="" cellspacing="" cellpadding="">
      ...
      <tr v-if="!listData.length">
        <td>1</td>
        <td>没有数据 . . .</td>
        <td v-for="(item0, index0) in theadData" v-if="index<=theadData.length-2"></td>
      </tr>
    ...
    <pagebar v-if="ifpage" :current="pageInfo.current" :showItem="pageInfo.showItem" :allpage="pageInfo.allpage"
